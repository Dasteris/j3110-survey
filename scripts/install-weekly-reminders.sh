...
# По умолчанию понедельник 10:00 по времени этого Mac — утро после сброса анкеты в 00:00.
# Если Mac в это время спал, launchd запустит рассылку при пробуждении; если был выключен — пропустит неделю.
#
